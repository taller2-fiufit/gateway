...
DB_HOST = os.environ.get("GATEWAY_POSTGRES_SERVICE_HOST")
DB_PORT = os.environ.get("GATEWAY_POSTGRES_SERVICE_PORT")
...
INITIAL_SERVICES = os.environ.get("INITIAL_SERVICES") or ""
